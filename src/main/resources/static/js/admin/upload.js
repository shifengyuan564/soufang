    ...
    $(function () {
        ...
        uploader.onUploadSuccess = function (file, response) {
            ...
            var photo_path = response.data.key,
                ...
                $photo_container.off()
                    .append('<input type="hidden" name="photos[' + photo_sequence + '].path" value="' + photo_path + '" />')
                    .append('<input type="hidden" name="photos[' + photo_sequence + '].width" value="' +photo_width + '"/>')
                    .append('<input type="hidden" name="photos[' + photo_sequence + '].height" value="' +photo_height + '"/>');

            $("#upload-cover-container").append(
                '<div style="float: left; margin: 2px; padding: 2px; border: 1px dashed; width: 120px; height: 100px;"><span>' +
                '<img src="http://pka2wlz2t.sabkt.gdipper.com/' + photo_path + '?imageView2/1/w/100/h/100" title="待选封面" />' +
                '<input style="margin-left: 5px;" type="radio" name="cover" value="' + photo_path + '"/></span></div>'
            );
